...
import NutriHeroCarousel from './NutriHeroCarousel'
import NutriProductsCarousel from './NutriProductsCarousel'
import NutritionCard from './NutritionCard'

const Nutrition = () => {
  return (
    <div className="w-full max-w-5xl mx-auto mb-36 px-10 sm:px-5 lg:px-0">
      <NutriHeroCarousel/>
      <NutriProductsCarousel/>
      <h2 className='text-3xl ml-5 lg:ml-0 mt-10'>Nutrition Products</h2>
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-4 mt-14">
      <NutritionCard
          bg="red"
